      ...
      <div class="container-fluid">
        <div>
          <nuxt-link to="/" class="navbar-brand">
            <img
              src="~/assets/IMG/Python_logo.png"
              alt="Python"
              class="navbar-brand"
              width="30"
              height="40"
          ...
          <nuxt-link to="/" class="navbar-brand">
            <img
              src="~/assets/IMG/NuxtJS_logo.png"
              alt="NuxtJS"
              class="navbar-brand"
              width="30"
              height="40"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <div class="navbar-nav me-auto mb-0 d-flex align-items-center">
            ...
            <span class="badge bg-secondary rounded-pill ms-lg-5"
              >Welcome, ...</span
            >
            <!-- {% endif %} -->
          </div>
          ...
          <div class="d-flex justify-content-center">
            ...
            <nuxt-link to="/" class="btn btn-outline-danger me-2"
              >Logout</nuxt-link
            >
            ...
            <!-- <a
              ...
              > -->
            <!-- {% else %} -->
            <nuxt-link to="/" class="btn btn-outline-secondary me-2"
              >Sign&nbsp;in</nuxt-link
            >
          ...
          <!-- colorMode switcher -->
          <div
            class="mt-lg-0 mt-1 m-0 d-flex flex-column align-items-center justify-content-center"
          >
