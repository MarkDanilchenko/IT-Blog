        ...
        <div class="d-flex flex-column align-items-center">
            ...
            <form class="col-lg-4 col-6" id="form-signUp" name="form-signUp" @submit.prevent="signUp">
                <fieldset class="form-group mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="username" id="username" class="form-control" placeholder="Username"
                            aria-describedby="usernameHelp" v-model="form.username" @input="$v.form.username.$touch()">
                        ...
                        <div v-if="!$v.form.username.maxLength">
                            <span class="text-small text-danger">Username should not exceed 150 symbols.</span>
                        </div>
                    </div>
                    <div class="mb-3">
                ...
                <div class="d-flex justify-content-center">
                    <button type="submit" class="btn btn-outline-success" :disabled="formIsFilled">Sign up!</button>
                </div>
            </form>
            ...
            <div class="text-end mb-5">
                <small class="text-muted">
                    Already registered? <nuxt-link class="nav-link" to="/accounts/signin/" title="Log in!"><b>Log
                            in!</b></nuxt-link>
                </small>
            </div>
        </div>
